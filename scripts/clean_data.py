...
df_goiaspen_db = pd.read_pickle('../data/base1.pkl')
df_bnmp_db = pd.read_pickle('../data/base2.pkl')
df_projudi_db = pd.read_pickle('../data/base3.pkl')
...
def main():
    ...
    # df_bnmp = df_bnmp.drop_duplicates(subset='numero_individuo', keep='first')
